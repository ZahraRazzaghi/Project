...
function rps_admin_style() {	
	wp_enqueue_style('rps-admin-style', plugins_url('/recent-posts-slider/css/rps-admin-style.css'));
}
...
class RpsWidget extends WP_Widget {
    /** constructor */
    function RpsWidget() {
        parent::__construct(false, $name = __('Recent Posts Slider','rps'), array( 'description' => __( 'Your blogs recent post using slider','rps') ));	
    }
