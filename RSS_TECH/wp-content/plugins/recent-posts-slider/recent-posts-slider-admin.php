...
<?php  }else{ ?>
<br/>
<p class="pro_text">Premium version is available at just <span class="pro_price">$5</span> <a href="http://recent-posts-slider.com/rps-store/" target="_blank">(Buy via PayPal or CreditCard)</a></p>
<p class="pro_text"><a href="http://recent-posts-slider.com/rps-pro-version-demo-theme1/" target="_blank"><b>Preview</b></a> & try it by yourself <a href="http://www.recent-posts-slider.com/rps-pro-demo/wp-login.php" target="_blank">here</a> Username : demo - Password : rpsdemo</p>
...
<table class="widefat rps_pro_table">
	...
	<tr>
		...
		<td><?php echo '<img src="' . plugins_url( 'img/yes.png' , __FILE__ ) . '" > '; ?><br/>
			<span class="normal">
				<strong><a target="_blank" href="http://recent-posts-slider.com/rps-pro-version-demo-theme1/">(Theme 1 Preview)</a><br/>
				<a target="_blank" href="http://recent-posts-slider.com/rps-pro-version-demo-theme-2/">(Theme 2 Preview )</a><br/>				<a target="_blank" href="http://recent-posts-slider.com/rps-pro-version-demo-theme-3/">(Theme 3 Preview )</a></strong>
			</span>
		</td>
	</tr>
	<tr>
	...
	<!--<tr>
		<td class="left">Custom Post Type</td>
		<td><?php echo '<img src="' . plugins_url( 'img/no.png' , __FILE__ ) . '" > '; ?></td>
		<td><?php echo '<img src="' . plugins_url( 'img/yes.png' , __FILE__ ) . '" > '; ?></td>
	</tr>-->
	<tr>
